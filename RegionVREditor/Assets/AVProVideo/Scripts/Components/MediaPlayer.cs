...
namespace RenderHeads.Media.AVProVideo
{
	...
	public class MediaPlayer : MonoBehaviour
	{
		...
		public class OptionsWindows : PlatformOptions
		{
			...
			{
				return (base.IsModified() || !useHardwareDecoding || useTextureMips || useUnityAudio || videoApi != Windows.VideoApi.MediaFoundation || !forceAudioResample ||
...
#region Platform and Path
	...
	// Setup for running builds
		...
		public virtual BaseMediaPlayer CreatePlatformMediaPlayer()
		{
			...
			mediaPlayer = new WindowsMediaPlayer(_optionsWindows.videoApi, _optionsWindows.useHardwareDecoding, _optionsWindows.useTextureMips, _optionsWindows.forceAudioOutputDeviceName, _optionsWindows.useUnityAudio, _optionsWindows.forceAudioResample, _optionsWindows.desiredAudioChannels);
#elif UNITY_WSA_10_0
			mediaPlayer = new WindowsMediaPlayer(Windows.VideoApi.MediaFoundation, _optionsWindowsUWP.useHardwareDecoding, _optionsWindowsUWP.useTextureMips, string.Empty, _optionsWindowsUWP.useUnityAudio, _optionsWindowsUWP.forceAudioResample, _optionsWindowsUWP.desiredAudioChannels);
#elif UNITY_WINRT_8_1
			mediaPlayer = new WindowsMediaPlayer(Windows.VideoApi.MediaFoundation, _optionsWindowsPhone.useHardwareDecoding, _optionsWindowsPhone.useTextureMips, string.Empty, _optionsWindowsPhone.useUnityAudio, _optionsWindowsPhone.forceAudioResample, _optionsWindowsPhone.desiredAudioChannels);
#endif
